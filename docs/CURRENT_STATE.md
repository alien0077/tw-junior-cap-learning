...
- M4：1,032/1,032 coverage rows 已建立 lesson 與題庫欄位；其中 104 rows／108 lessons 為 `content-reviewed`，928 rows／928 lessons 明確維持 `draft`。每單元至少 10 題，數學／自然具 3 步互動；仍不代表教師／學科專家審閱。
...
- M4 原創內容：目前 1,036 份 lesson、10,360 題 question，均標示 `origin=original` 並連至既有 KG ID；lesson 狀態為 108 `content-reviewed`、928 `draft`，仍不宣稱外部教師審閱完成。
...
- 2026-08-26：M4 全量結構建立完成；coverage matrix 1,032/1,032 rows 均有 lesson，狀態為 104 `content-reviewed`、928 `draft`；最新 validator 通過 12,571 JSON files、12,558 IDs、1,032 KG nodes。此狀態不等同 `teacher-reviewed`。
...
- M4 批次進度：1,032/1,032 筆 coverage rows 已 materialize，共 1,036 份 lesson、10,360 題 question；數學／自然互動狀態 0 筆 pending；104 筆為 repo 內部 `content-reviewed`、928 筆維持 `draft`。
