...
- M4 批次進度：1,032/1,032 筆 coverage rows 已 materialize，共 1,036 份 lesson、10,360 題 question；數學／自然互動狀態 0 筆 pending。已有 89 筆 `content-reviewed`（國文 84 筆全數完成 repo 內部 QA），其餘 943 筆仍為 `draft`。
