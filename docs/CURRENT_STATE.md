...
- M4：目前有 13 份 lesson、130 題 question；每個 lesson 已配置至少 10 題，均依 docs/M4_CONTENT_METHOD.md 以課綱／KG 目標自行撰寫，含答案與解析，但仍不代表五科教材或題庫覆蓋完成。
...
- M4-003 已開始：國文已完成 3/84 筆（新增 3 lesson、30 question），其餘 81 筆仍待補全。
