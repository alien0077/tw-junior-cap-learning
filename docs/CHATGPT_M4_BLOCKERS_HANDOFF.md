...
| 科目 | draft lesson | 通用模板 lesson | draft question | 重複題幹題數 |
|---|---:|---:|---:|---:|
| 國文 | 63 | 63 | 630 | 280 |
| 英文 | 131 | 131 | 1,310 | 370 |
| 數學 | 47 | 47 | 470 | 0 |
| 自然 | 315 | 315 | 3,150 | 2,780 |
| 社會 | 359 | 359 | 3,590 | 3,070 |

請優先回傳自然／社會的重複題幹與固定摘要中，哪些需要重寫；不得只依重複字串直接判定題目錯誤。
