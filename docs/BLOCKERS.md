...
## B-005：M4 全課綱 coverage matrix 尚未建立

- 狀態：進行中（2026-08-25）
- 影響：目前只有 10 份代表性 lesson 與 100 題，不能宣稱 1,032 個課綱節點已覆蓋。
- 下一步：先 materialize 1,032 個 curriculum／KG 節點的 coverage matrix，再按國文、英文、數學、自然、社會順序補全。
