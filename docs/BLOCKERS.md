...
## B-024：題庫仍有 9,230 題 draft

- 狀態：進行中（2026-08-26）
- 現況：全庫 10,360 題中，1,130 題為 `content-reviewed`、9,230 題為 `draft`；lesson 與 coverage row 的內部 QA 狀態另行計算。
...
## B-025：494 份 draft lesson 仍為批次通用模板

- 狀態：進行中（2026-08-26）
- 現況：數學、國文與自然 QA 批次完成後，QA 稽核辨識英文 135、社會 359，共 494 份 lesson 的摘要仍使用固定批次句型；另有 361 份 draft lesson 為非固定模板但仍待內容核對。
