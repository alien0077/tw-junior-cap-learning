...
- 狀態：本機已解決（2026-08-27）；遠端發佈待使用者授權提交／推送。
...
- 遠端結果：舊版 workflow run `32935192763` 成功；新的固定 revision workflow 已寫入工作區，尚未提交／推送。
- 下一步：取得提交／推送授權後，部署指定 commit 並以公開 URL 重做相同 smoke test。
