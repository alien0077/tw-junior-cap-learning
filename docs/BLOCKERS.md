...
## B-024：題庫仍有 10,140 題 draft

- 狀態：進行中（2026-08-26）
- 現況：全庫 10,360 題中，220 題為 `content-reviewed`、10,140 題為 `draft`；lesson 與 coverage row 的內部 QA 狀態另行計算。
- 限制：在逐題內容核對與外部教師／學科專家審閱完成前，不得將 draft 題目宣稱為完整審核題庫。
- 2026-08-26 更新：稽核發現 draft lesson 下另有 6,630 題模板題原先誤標 `content-reviewed`，已全部校正；共 10,140 題 draft 的單元內題幹已分為 10 種認知任務變體，但選項仍為保守模板，故維持 `draft`，未視為內容審核完成。
- 2026-08-26 新增合法題源：官方[歷屆試題入口](https://cap.rcpet.edu.tw/examination.html)可用於命題範圍／題型查核；未取得明確授權前不複製題文，仍需逐題自編、核對與審閱。
- 2026-08-26：10,140 題 draft 均有 provenance；其中 2,650 題連結官方會考入口，其餘連結官方課綱來源，均未複製題文。
- 2026-08-26：數學 15 個可客觀計算單元已先完成 150 題數值／公式題替換；仍需數學科逐題核對，未升級狀態。

## B-025：919 份 draft lesson 仍為批次通用模板

- 狀態：進行中（2026-08-26）
- 現況：QA 稽核辨識國文 63、英文 135、數學 47、自然 315、社會 359，共 919 份 lesson 的摘要仍使用固定批次句型。
