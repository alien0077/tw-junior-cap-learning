...
- 2026-08-26 更新：已將 2,650 題的單元內題幹改為 10 種認知任務變體；選項仍為保守模板，故仍維持 `draft`，未視為內容審核完成。
- 2026-08-26 新增合法題源：官方[歷屆試題入口](https://cap.rcpet.edu.tw/examination.html)可用於命題範圍／題型查核；未取得明確授權前不複製題文，仍需逐題自編、核對與審閱。
- 2026-08-26：2,650 題 draft 已全部連結該官方入口的 provenance（定位為範圍／題型查核，非題文來源）。
