...
- 2026-08-26 更新：稽核發現 draft lesson 下另有 6,630 題模板題原先誤標 `content-reviewed`，已全部校正；共 9,280 題的單元內題幹已分為 10 種認知任務變體，但選項仍為保守模板，故維持 `draft`，未視為內容審核完成。
- 2026-08-26 新增合法題源：官方[歷屆試題入口](https://cap.rcpet.edu.tw/examination.html)可用於命題範圍／題型查核；未取得明確授權前不複製題文，仍需逐題自編、核對與審閱。
- 2026-08-26：9,280 題 draft 已全部連結該官方入口的 provenance（定位為範圍／題型查核，非題文來源）。
