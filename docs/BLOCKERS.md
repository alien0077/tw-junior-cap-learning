...
## B-024：題庫仍有 9,400 題 draft

- 狀態：進行中（2026-08-26）
- 現況：全庫 10,360 題中，960 題為 `content-reviewed`、9,400 題為 `draft`；lesson 與 coverage row 的內部 QA 狀態另行計算。
...
## B-025：872 份 draft lesson 仍為批次通用模板

- 狀態：進行中（2026-08-26）
- 現況：數學 QA 批次完成後，QA 稽核辨識國文 63、英文 135、自然 315、社會 359，共 872 份 lesson 的摘要仍使用固定批次句型。
