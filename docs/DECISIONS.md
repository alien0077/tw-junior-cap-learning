...
- 驗證：共重寫 7,820 題（社會 3,590、自然 3,240、英文 1,350）；`validate_data.py` 通過，答案選項對齊、provenance、每課至少 10 題及 exact duplicate 檢查通過。新增 `audit_m4_semantic_risk.py`，以保守語意骨架掃描列出 31 個跨課風險；這些題目與 70 個 lesson 標題草稿標記均不升級，等待 Terra 第二輪 AI 複核。
