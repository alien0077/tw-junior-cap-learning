...
| M4-002 | 全課綱 coverage matrix | 1,032 個節點逐一列出 subject、grade、KG、lesson、question、互動狀態 | 進行中 |
| M4-003 | 國文教材與題庫 | 所有國文節點完成 lesson 與每單元 10 題 | 待 M4-002 |
...
- 2026-08-25：M4-002 開始。全課綱 coverage matrix 尚未建立，因此目前不能宣稱 M4 完整。
