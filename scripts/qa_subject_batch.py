...
todo=[r for r in rows if isinstance(r,dict) and r.get('subject')==subject and r.get('lessonId','').startswith(f'lesson-{subject}-content-') and r.get('reviewStatus')!='content-reviewed'][:limit]
for r in todo:
